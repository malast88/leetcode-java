...
public class MinimumDepthOfBinaryTreeTest {
    ...
    @InjectMocks
    private MinimumDepthOfBinaryTree sut;
    ...
    private static Stream<Arguments> getMinDepthArgs() {
        return Stream.of(
                ...
                Arguments.of(getTree(3, 9, 20, null, null, 15, 7), 2)
        );
    }
    ...
    public void itShouldGetMinDepth(TreeNode root, int expectedResult) {
        // init

        // test
        int result = sut.minDepth(root);
