...
public class BalancedBinaryTreeTest {
    ...
    @InjectMocks
    private BalancedBinaryTree sut;

    private static Stream<Arguments> getIsBalancedArgs() {
        return Stream.of(
                Arguments.of(getTree(), true),
                Arguments.of(getTree(3, 9, 20, null, null, 15, 7), true),
                Arguments.of(getTree(1, 2, 2, 3, 3, null, null, 4, 4), false)
        );
    }
    ...
    @ParameterizedTest
    @MethodSource("getIsBalancedArgs")
    public void itShouldAnswerIfItIsBalanced(TreeNode root, boolean expectedResult) {
        // init
